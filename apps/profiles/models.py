...
class Profile(TimeStampedUUIDModel):
    ...
    city=models.CharField(verbose_name=_("City"),default="Mumbai",max_length=100,blank=False,null=False)
    is_buyer=models.BooleanField(verbose_name=_("Buyer"),default=False,help_text=_("Are you looking to buy any property"))
    is_seller=models.BooleanField(verbose_name=_("Seller"),default=False,help_text=_("Are you looking to sell any property"))
    ...
    raiting_agent=models.DecimalField(max_digits=4,decimal_places=2,null=True,blank=True)
